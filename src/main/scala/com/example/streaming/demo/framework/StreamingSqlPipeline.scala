...
object StreamingSqlToKafka {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val kafkaSrc1MetaData = KafkaMetaData(props, topic1,
      TopicDataType.Avro,
      m_schema_str_src_1,
    ...
    val kafkaSrc2MetaData = KafkaMetaData(props, topic2,
      TopicDataType.Avro,
      m_schema_str_src_2,
    ...
    val kafkaTargetMetaData = KafkaMetaData(props, targetTopic,
      TopicDataType.Avro,
      m_schema_str_target,
    ...
    val myrecordT1KafkaCommitMetaData = KafkaCommitMetaData(props, "commit_t1")
